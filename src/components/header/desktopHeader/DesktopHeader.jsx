import header from "./desktopHeader.module.css";
import global from "../../../styles/globalStyle.css";
import HeaderLink from "../headerLink/HeaderLink";

const DesktopHeader = () => {
    return (
        <div className={header.header}>
            <a href={"https://vk.com/megurx"} target="_blank" rel={"noreferrer"} className={header.logo}>
            ...
            <nav className={header.navItems}>
                <HeaderLink
                    to={"https://vk.com/megurx"}
            ...
            <div className={header.findContainer}>
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <path
                        d="M15.9248 15.3394L23.0946 22.5092" stroke="#9D9D9D" strokeWidth="1.79246"
                        strokeLinecap="round" strokeLinejoin="round"/>
                </svg>
                <input className={header.findInput} placeholder={"Search Art Work / Creator"}></input>
            </div>
            <button className={[global.buttonCursor, header.connectButton].join(" ")}>
                <div className={header.connectButtonTitle}>
                    Connect wallet
                </div>
            </button>
        </div>
